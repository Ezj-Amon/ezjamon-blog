...
Before reading the rest of the section, you might also want to check [this article](https://ezjamon.com/posts/how-to-update-dependencies/) for upgrading dependencies and AstroPaper.
...
Actually, I've already written a blog post for this case and you can check out [here](https://ezjamon.com/posts/how-to-update-dependencies/#updating-astropaper-using-git).
