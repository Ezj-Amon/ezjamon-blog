...
AstroPaper v2 has a new dark color scheme (high contrast & low contrast) which is based on Astro's dark logo. Check out [this link](https://ezjamon.com/posts/predefined-color-schemes#astro-dark) for more info.
...
All the [#docs](https://ezjamon.com/tags/docs/) blog posts and [README](https://github.com/satnaing/astro-paper#readme) are updated for this AstroPaper v2.
