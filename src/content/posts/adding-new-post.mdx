...
> [!TIP]
> Since AstroPaper v1.4.0, OG images are generated automatically if not specified. Check out [the announcement](https://ezjamon.com/posts/dynamic-og-image-generation-in-astropaper-blog-posts/).
